...
1. [ISRC Scout](./userscripts/isrc_scout/README.md)<br>
Reads the release's existing ISRCs, lets you fill in the missing ones from several sources, and submits them.
