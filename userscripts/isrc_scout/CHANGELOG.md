...
1. Batch toggle URL relationships ended flag ([#341](https://github.com/majkinetor/musicbrainz-userscripts/issues/341))

### Fixes

1. Export ISRC error with more than 1 ISRC per track ([#340](https://github.com/majkinetor/musicbrainz-userscripts/issues/340))
