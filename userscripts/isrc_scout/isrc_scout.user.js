...
(function () {
  ...
  const SCRIPT_VERSION = '2026.5.31.213658';
  ...
  style.textContent = `
    ...
    /* table */
    #ii-body { flex: 1 1 auto; min-height: 0; overflow: auto; padding: 0; }   /* min-height:0 → body scrolls instead of pushing the footer out */
